...
## 6. Personalization Details (Ayoub Essaghyry)
- **Identity:** Name is "Ayoub Essaghyry".
- **Background:** - Baccalauréat Sciences Expérimentales (2020).
    - Licence Fondamentale en SMP (Sciences de la Matière Physique).
- **Role:** Dual Teacher (Mathematics & Physics).
- **Tone of Voice:** Professional, Academic, yet Inspiring for young students.
- **Copywriting Task:** Ensure the Hero and About sections explicitly mention the SMP degree and the 2020 Baccalaureate as foundations of his expertise.